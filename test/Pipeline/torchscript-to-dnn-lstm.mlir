// RUN: dnn-opt -torchscript-to-dnn-pipeline='captures=dnn.lstm' %s | FileCheck %s
// RUN: dnn-opt --dnn-backend-to-linalg-on-tensors-backend-pipeline='captures=dnn.lstm' %s | FileCheck %s --check-prefix=LINALG
