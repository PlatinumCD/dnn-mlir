...
func.func @convert_gru_input(
  ...
  %result:2 = torch.operator "torch.aten.gru.input"(
...
// CHECK-LABEL: func.func @convert_gru_input
// CHECK: dnn.gru
...
// CHECK-NOT: torch.operator "torch.aten.gru.input"
