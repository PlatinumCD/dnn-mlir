...
func.func @convert_rnn_tanh_input(
  ...
  %result:2 = torch.operator "torch.aten.rnn_tanh.input"(
...
// CHECK-LABEL: func.func @convert_rnn_tanh_input
// CHECK: dnn.rnn
...
// CHECK-NOT: torch.operator "torch.aten.rnn_tanh.input"
