...
func.func @convert_rnn_relu_data(
  ...
  %result:2 = torch.operator "torch.aten.rnn_relu.data"(
...
// CHECK-LABEL: func.func @convert_rnn_relu_data
// CHECK: dnn.rnn
// CHECK-SAME: activation = "relu"
// CHECK-SAME: kind = "aten.rnn_relu.data"
...
// CHECK-NOT: torch.operator "torch.aten.rnn_relu.data"
