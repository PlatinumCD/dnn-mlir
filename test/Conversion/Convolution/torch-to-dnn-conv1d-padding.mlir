...
func.func @convert_aten_conv1d_padding(%input: !torch.vtensor<[1,2,8],f32>, %weight: !torch.vtensor<[4,2,3],f32>, %bias: !torch.vtensor<[4],f32>) -> !torch.vtensor<[1,4,8],f32> {
  ...
  %result = torch.aten.conv1d.padding %input, %weight, %bias, %one, %padding, %one, %groups
...
// CHECK-LABEL: func.func @convert_aten_conv1d_padding
// CHECK: dnn.convolution
// CHECK-SAME: kind = "aten.conv1d.padding"
// CHECK-NOT: torch.aten.conv1d.padding
