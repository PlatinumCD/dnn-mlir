...
func.func @convert_aten_underscore_convolution(%input: !torch.vtensor<[1,2,8,8],f32>, %weight: !torch.vtensor<[4,2,3,3],f32>, %bias: !torch.vtensor<[4],f32>) -> !torch.vtensor<[1,4,6,6],f32> {
  ...
  %result = torch.aten._convolution %input, %weight, %bias, %one, %zero, %one, %false, %zero, %groups, %false, %false, %false, %false
...
// CHECK-LABEL: func.func @convert_aten_underscore_convolution
// CHECK: dnn.convolution
// CHECK-SAME: kind = "aten._convolution"
